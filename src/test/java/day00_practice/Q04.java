...
//disable notification parameter
       ...
       js.executeScript("scrollBy(0,200)");
        ...
        System.out.println("Siparis ozeti yazisi : "+ driver.findElement(By.className("cart-sum-title")));

        driver.findElement(By.xpath("//a[@title='Alışverişi Tamamla']")).click();

        System.out.println("Hosşgeldiniz Yazisi " + driver.findElement(By.xpath("//div[.='Teknosa’ya hoş geldiniz']")).getText());
